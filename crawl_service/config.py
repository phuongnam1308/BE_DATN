...
TRAINING_DB_CONFIG = {
    "host": get_env_var("TRAINING_DB_HOST", "localhost"),
    "port": get_env_var("TRAINING_DB_PORT", "5432"),
    "database": get_env_var("TRAINING_DB_NAME", "training_db"),
    "user": get_env_var("TRAINING_DB_USER", "postgres"),
    "password": get_env_var("TRAINING_DB_PASSWORD", "123456789")
}

TRAINING_SERVICE_URL = get_env_var("TRAINING_SERVICE_URL", "http://localhost:8002")
CRAWL_SERVICE_PORT = int(get_env_var("CRAWL_SERVICE_PORT", "8001"))
CHROMEDRIVER_PATH = get_env_var("CHROMEDRIVER_PATH", "D:/AI_FITHOU/test/chromedriver-win64/chromedriver.exe")
PROFILE_PATH = get_env_var("PROFILE_PATH", "C:/Users/proca/AppData/Local/Google/Chrome/User Data")
TARGET_POSTS = int(get_env_var("TARGET_POSTS", "6"))
...
logger.info(f"TRAINING_SERVICE_URL: {TRAINING_SERVICE_URL}")
logger.info(f"CRAWL_SERVICE_PORT: {CRAWL_SERVICE_PORT}")
logger.info(f"CHROMEDRIVER_PATH: {CHROMEDRIVER_PATH}")
logger.info(f"PROFILE_PATH: {PROFILE_PATH}")
logger.info(f"TARGET_POSTS: {TARGET_POSTS}")
